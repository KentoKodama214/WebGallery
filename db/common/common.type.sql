...
-- お問い合わせステータス
CREATE TYPE common.inquiry_status_enum AS ENUM ('unreplied', 'replied');
COMMENT ON TYPE common.inquiry_status_enum IS 'お問い合わせステータスを管理するEnum型: unreplied(未対応)、replied(回答済み)';
