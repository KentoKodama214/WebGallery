...
class ImageFilePathTest {
  ...
  void constructor_success() {
    ImageFilePath actual = new ImageFilePath("1/1-abcde.jpg");

    assertEquals("1/1-abcde.jpg", actual.value());
  }

  @Test
  @DisplayName("異常系：nullを指定した場合、IllegalArgumentExceptionをスローすること")
  void constructor_null() {
    assertThrows(IllegalArgumentException.class, () -> new ImageFilePath(null));
  }
}
