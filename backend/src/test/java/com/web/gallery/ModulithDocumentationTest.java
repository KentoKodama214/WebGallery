 ...
 *
 * <p>モジュール構成図（PlantUML）とモジュールキャンバス（AsciiDoc）を
 * {@code doc/modulith/} 配下に自動生成する。</p>
 *
 * <p>実行方法: {@code ./backend/gradlew -p backend generateModulithDocs}</p>
 */
