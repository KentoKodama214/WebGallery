...
insert into photo.photo_view_log (photo_view_log_no, photo_account_no, account_no, photo_no, referer, ip_address, country, region, created_by, created_at) values (1, 2, 1, 1, 'https://example.com/', '198.51.100.1', 'US', 'California', 2, '2024-01-01 00:00:00 Asia/Tokyo');
