...
insert into common.inquiry_mst values(2, 1, 2, 1, '2024-01-02 09:00:00 Asia/Tokyo', 1, '2024-01-02 09:00:00 Asia/Tokyo', '未読の問い合わせ', '未読状態の問い合わせ本文です。', 'unreplied', false);
insert into common.inquiry_mst values(3, 1, 3, 1, '2024-01-03 09:00:00 Asia/Tokyo', 1, '2024-01-03 09:00:00 Asia/Tokyo', '取り下げ対象の問い合わせ', '取り下げ対象の問い合わせ本文です。', 'unreplied', true);
