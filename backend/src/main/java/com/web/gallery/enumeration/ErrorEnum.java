...
public enum ErrorEnum {
   ...
   * エラーコード：E-C-0000
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_INVALID_INPUT}
   */
   ...
   * エラーコード：E-C-0001
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAIL_TO_REGIST_ACCOUNT}
   */
   ...
   * エラーコード：E-C-0002
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAIL_TO_UPDATE_ACCOUNT}
   */
   ...
   * エラーコード：E-C-0003
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_NOT_AUTHORIZED_TO_EDIT_ACCOUNT}
   */
   ...
   * エラーコード：E-P-0002
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAIL_TO_UPDATE_PHOTO}
   */
   ...
   * エラーコード：E-P-0003
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAIL_TO_DELETE_PHOTO}
   */
   ...
   * エラーコード：E-P-0004
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAIL_TO_REGIST_PHOTO_TAG}
   */
   ...
   * エラーコード：E-P-0005
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAIL_TO_REGIST_FAVORITE}
   */
   ...
   * エラーコード：E-P-0006
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAIL_TO_CANCEL_FAVORITE}
   */
   ...
   * エラーコード：E-P-0007
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_DUPLICATE_PHOTO_FILE}
   */
   ...
   * エラーコード：E-P-0008
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_NOT_AUTHORIZED_TO_EDIT_PHOTO}
   */
   ...
   * エラーコード：E-P-0009
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_PHOTO_NOT_FOUND}
   */
   ...
   * エラーコード：E-P-0010
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_REACHED_REGISTRATION_LIMIT}
   */
   ...
   * エラーコード：E-P-0011
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_INVALID_PHOTO_FILE_EXTENSION}
   */
   ...
   * エラーコード：E-P-0012
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_IMAGE_FILE_REQUIRED}
   */
   ...
   * エラーコード：E-P-0013
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_UNSUPPORTED_IMAGE_CONTENT_TYPE}
   */
   ...
   * エラーコード：E-P-0014
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_INVALID_IMAGE_SIGNATURE}
   */
   ...
   * エラーコード：E-P-0015
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_IMAGE_FILE_SIZE_EXCEEDED}
   */
   ...
   * エラーコード：E-P-0016
   *
   * <p>エラーメッセージ：{@value MessageConst#ERR_FAVORITE_NOT_FOUND}
   */
