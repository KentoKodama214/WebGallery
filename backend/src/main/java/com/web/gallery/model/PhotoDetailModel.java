...
public class PhotoDetailModel {
	...
	public static PhotoDetailModel from(PhotoDetailDto dto, List<PhotoTagMst> photoTagMstList) {
		...
		return PhotoDetailModel.builder()
				...
				.address(dto.getAddress() != null ? new Address(dto.getAddress()) : null)
				.latitude(dto.getLatitude() != null ? new Latitude(dto.getLatitude()) : null)
				.longitude(dto.getLongitude() != null ? new Longitude(dto.getLongitude()) : null)
				...
				.focalLength(dto.getFocalLength() != null && dto.getFocalLength() != 0 ? new FocalLength(dto.getFocalLength()) : null)
				.fValue(dto.getFValue() != null && dto.getFValue().compareTo(BigDecimal.ZERO) == 1 ? new FValue(dto.getFValue()) : null)
				.shutterSpeed(dto.getShutterSpeed() != null && dto.getShutterSpeed().compareTo(BigDecimal.ZERO) == 1 ? new ShutterSpeed(dto.getShutterSpeed()) : null)
				.iso(dto.getIso() != null && dto.getIso() != 0 ? new Iso(dto.getIso()) : null)
