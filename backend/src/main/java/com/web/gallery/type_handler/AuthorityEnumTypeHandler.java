...
public class AuthorityEnumTypeHandler extends BaseTypeHandler<AuthorityEnum> {
  ...
  public void setNonNullParameter(
      PreparedStatement ps, int i, AuthorityEnum parameter, JdbcType jdbcType) throws SQLException {
  ...
  @Override
  public AuthorityEnum getNullableResult(CallableStatement cs, int columnIndex)
      throws SQLException {
