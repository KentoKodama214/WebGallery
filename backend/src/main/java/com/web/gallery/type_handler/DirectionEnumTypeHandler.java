...
public class DirectionEnumTypeHandler extends BaseTypeHandler<DirectionEnum> {
  ...
  public void setNonNullParameter(
      PreparedStatement ps, int i, DirectionEnum parameter, JdbcType jdbcType) throws SQLException {
  ...
  @Override
  public DirectionEnum getNullableResult(CallableStatement cs, int columnIndex)
      throws SQLException {
  ...
  private DirectionEnum fromDbValue(String dbValue) {
    ...
    for (DirectionEnum direction : DirectionEnum.values()) {
      if (direction.getDbValue().equals(dbValue)) return direction;
    }
    return null;
  }
}
