 ...
 *
 * 写真の新規一括登録で1リクエストにつき最大10枚（Consts.PHOTO_BULK_REGIST_MAX_SIZE）まで
 * 送信できるため、1ファイルあたりの上限（app.photo.maxFileSizeMb=5MB）×10枚+αを確保する
 */
 ...
 *
 * 複数枚の写真一括登録で最大 {@link MAX_BODY_SIZE} 相当のアップロードが発生しうるため、
 * 低速回線でも上限サイズを送り切れるよう十分な時間を確保する
 */
 ...
 * （特に最大 {@link MAX_BODY_SIZE} をバッファしうるアップロード）で Node プロセスの
